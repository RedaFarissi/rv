...
function App() {
    ...
    const laravel_matrix = [
      ["MVC","what_is_laravel","what_we_need_to_use_laravel","First_Laravel_Project","run_project","artisan","views","route","resources","request","Controller","layoute_page","css_and_javaScript","route_and_name","handle_data_in_views","create_controller_to_use_data","method_in_controller","recource","list_all_route_in_project"],
