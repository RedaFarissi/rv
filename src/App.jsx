...
function App() {
  ...
  const js_matrix = [
    ...
    ["Window","alert","confirm","prompt","btoa","atob","location","innerWidth","innerHeight","clientWidth","scrollBy","pageXOffset","PageYOffset","pageX","pageY","scrollIntoView","scrollTop","console","getComputedStyle","localStorage","sessionStorage","matchMedia","navigator","print",],
