...
function App() {
    ...
    const laravel_matrix = [
      ...
      ["database","Connect_with_database","Create_models","migrate","create_table_in_db_from_laravel","Add_Column_In_Table","Foreign_Keys","drop_ping_Columns_From_Table","truncate_models_table","drop_The_Last_Migrate_In_DB","Clear_all_table_in_db_and_create_him_again","soft_delete","eloquent_scopes","Seeder_class"],
