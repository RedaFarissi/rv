...
<div style={{marginTop: "200px"}} onClick={props.boxProfileStyle}>
    ...
    <section style={{ marginRight: "8%" ,  marginLeft: "8%"}} >
        <div className="container mt-5 alert" style={{backgroundColor:"#171c2c"}}>
            <div className=" shadow p-4">
                <form method="POST" onSubmit={handleCreatePost}>
                    <div className="mb-3 text-end">
                        <label for="title" className="form-label f-family">عنوان :</label>
                        <input 
                    ...
                    <div className="mb-3 text-end">
                        <label for="question" className="form-label f-family">اشرح سؤالك بالتفصيل :</label>
                        <textarea id="text" name="text" className="form-control" value={dataForm.text}  style={{minHeight: "220px"}}
                            onChange={handleInputChange} required></textarea>
                    </div>

                    <div className="mb-3 text-end">
                        <label for="language" className="form-label f-family">اللغات المستخدمة :</label>
                        <input 
