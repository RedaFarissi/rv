{% load static %} 
<h1 class="heading-style-js"><u><i> JavaScript Regular </i></u></h1>
...
<div class="sum_exemple_style">
    ...
    <img src="{% static 'js/js25_Regular.png' %}" class="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div class="styleee img"><h2> Kamal Eskouni Reda </h2></div>
</div>
<div class="sum_exemple_style">
    ...
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js25_Regular2.png' %}" class="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div class="styleee img"><h2> Kamal Eskouni Kamal </h2></div>
</div>
<div class="sum_exemple_style">
    ...
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js25_Regular3.png' %}" class="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div class="styleee img"><h2> Kamal Eskouni reda </h2></div>
</div>
<div class="sum_exemple_style">
    ...
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js25_Regular4.png' %}" class="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div class="styleee img"><h2> @ Eskouni @ </h2></div>
</div>
<div class="mital">متال 5:  </div>
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js25_Regular5.png' %}" class="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div class="styleee img"><h2>true<br>A,B,C,D,a,b,c,d</h2></div>
</div>