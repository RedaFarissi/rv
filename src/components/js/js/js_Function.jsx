{% load static %} 
<h1 className="heading-style-js"><u><i> JavaScript Function </i></u></h1>
<h3> 1. Function</h3>
...
<div className="sum_exemple_style">
    ...
    <img src="{% static 'js/js21_Function.png' %}" className="img">
</div>
<div className="sum_exemple_style">
    <div className="mital"> متال 2 :  </div>
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js21_Function2.png' %}" className="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div className="styleee img"><h2> reda Eskouni </h2></div>
</div>
<div className="sum_exemple_style">
    <div className="mital"> متال 3 :  </div>
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js21_Function3.png' %}" className="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div className="styleee img"><h2> Aymane El Toumi </h2></div>
</div>
<div className="sum_exemple_style">
    <div className="mital"> متال 4 :  </div>
    <ul><li>يمكن إنشاء دالة <small><small>(function)</small></small> بدون <b>parameters</b></li></ul>
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js21_Function4.png' %}" className="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div className="styleee img"><h2 style="color:red;border:2px solid black;padding:9px;width:max-content;margin:auto;"> First Name : Reda<br>Last Name : Eskouni<br>Age : 25<br>Nationality : Moroccan </h2></div>
</div>
<div className="sum_exemple_style">
    ...
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js21_Function5.png' %}" className="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div className="styleee img"><h2> 
...
<div className="mital"> متال :  </div>
<h4 style="color:green"> الكود </h4>
<img src="{% static 'js/js21_Function6.png' %}" className="img">
<h4 style="color:green"> بعد تشغيل الأكواد </h4>
<div className="styleee img"><h2>2<br>4<br>6<br>8<br>10<br>12<br>14<br>16<br>18<br>20 </h2></div>
...
<div className="mital"> متال :  </div>
<h4 style="color:green"> الكود </h4>
<img src="{% static 'js/js21_Function7.png' %}" className="img">
<h4 style="color:green"> بعد تشغيل الأكواد </h4>
<div className="styleee img"><h2>520</h2></div>
...
<div className="style_divv">
    ...
    <div className="codeStudio alert bg-dark" dir="ltr" style="margin-top: 12px;">
...
<h4 style="color:green"> الكود </h4>
<img src="{% static 'js/js21_Function8.png' %}" className="img">
<h4 style="color:green"> بعد تشغيل الأكواد </h4>
<div className="styleee img"><h2>199</h2></div>