{% load static %} 
<h1 class="heading-style-js"><u><i> JavaScript location </i></u></h1>
...
<div class="sum_exemple_style">
    ...
    <img src="{% static 'js/js34_location.png' %}" class="img">
...
<h3>2- <bdi>location.hostname</bdi></h3>
<div class="style_divv">
    تعرض خاصية <bdi><b>location.host</b></bdi> المضيف <bdi><small>(عنوان IP أو domain)</small></bdi> ومنفذ عنوان <b>URL</b>.<br>
...
<div class="sum_exemple_style">
    <div class="mital"> متال :  </div>
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js34_location2.png' %}" class="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div class="styleee img">
        <h2 id="h22"> </h2>
    </div>
...
<div class="sum_exemple_style">
    <div class="mital"> متال :  </div>
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js34_location3.png' %}" class="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div class="styleee img">
        <h2 id="h222"> </h2>  
    </div>
...
<h3>4- <bdi>location.origin</bdi></h3>
<div class="style_divv">
...
<div class="sum_exemple_style">
    <div class="mital"> متال :  </div>
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js34_location4.png' %}" class="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div class="styleee img">
        <h2 id="h2222"> </h2>  
    </div>
...
<h3>5- <bdi>location.pathname</bdi></h3>
<div class="style_divv">
...
<div class="sum_exemple_style">
    <div class="mital"> متال :  </div>
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js34_location5.png' %}" class="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div class="styleee img">
        <h2 id="h22222"> </h2>  
    </div>
...
<h3>6- <bdi>location.protocol</bdi></h3>
<div class="style_divv">
...
<div class="sum_exemple_style">
    <div class="mital"> متال :  </div>
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js34_location6.png' %}" class="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div class="styleee img">
        <h2 id="h222222"> </h2>
    </div>
...
<h3>7- <bdi>location.reload()</bdi></h3>
<div class="style_divv">
...
<div class="sum_exemple_style">
    <div class="mital"> متال :  </div>
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js34_location7.png' %}" class="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div class="styleee img">
...
<h3>8- <bdi>location.replace()</bdi></h3>
<div class="style_divv">
