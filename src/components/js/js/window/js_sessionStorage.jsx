{% load static %} 
<h1 class="heading-style-js"><u><i> JavaScript sessionStorage </i></u></h1>
...
<div class="sum_exemple_style">
    ...
    <img src="{% static 'js/js49_sessionStorage.png' %}" class="img">
...
<div class="sum_exemple_style">
    ...
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js49_sessionStorage2.png' %}" class="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div class="styleee img">       
        <h2> Reda <br> null </h2>
    </div>
