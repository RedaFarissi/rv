{% load static %} 
<h1 class="heading-style-js"><u><i>  JavaScript querySelector </i></u></h1>
...
<div class="style_divv">
    ...
    يطرح كل من <bdi><b>querySelector()</b></bdi> و <bdi><b>querySelectorAll()</b></bdi> استثناء <b class="text-danger">SYNTAX_ERR</b> إذا كان المحدد (المحددات) غير صالح.
...
<div class="sum_exemple_style">
    ...
    <img src="{% static 'js/js76_querySelector.png' %}" class="img">
...
<div class="sum_exemple_style">
    ...
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js76_querySelector2.png' %}" class="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div class="styleee img"> 
        <div class="partent">
            <div class="child" style="background-color:red;"> child 1 </div>
            <div class="child"> child 2 </div>
            <div class="child"> child 3 </div>
        </div>
    </div>
</div>
<h3>2- The Difference Between an HTMLCollection and a NodeList</h3>
<div class="style_divv">
    ...
    ترجع طريقة <bdi><b>querySelectorAll() NodeList</b> ثابتة.<br>
