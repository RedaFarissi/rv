...
object.addEventListener("loadeddata", function_name )`
    const codeExemple1= { 
    code: `      <video controls onloadstart="function_name()" onloadedmetadata="function_name3()" ondurationchange="function_name2()" onloadeddata="function_name4()" width="50%">
...
<section className="section-conetent">
    ...
    <article>
        ...
        <CodeHighlighter file_name="index.html" code={codeExemple1.code} language="html" is_html={true} title="onloadeddata" addClass="mt-3 mb-3" copie={true}  number={false}/>  
