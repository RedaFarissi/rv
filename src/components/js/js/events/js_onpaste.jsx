...
<h1 class="heading-style-js"><u><i>  JavaScript onpaste </i></u></h1>
<div class="style_divv mt-5">
    ...
    <div class="alert alert-warning text-dark my-3">
        <b class="d-block my-2">نصيحة</b>:<br>
        هناك ثلاث طرق للصق بعض المحتوى في عنصر:<br>
        <ul>
            <li> اضغط على <kbd class="bg-secondary">Ctrl + V</kbd></li>
...
<div class="sum_exemple_style">
    ...
    <img src="{% static 'js/js124_onpaste.png' %}" class="img">
