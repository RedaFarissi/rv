...
function mouseUp() {
  ...
  <section className="section-conetent">
    ...
    <article>
        ...
        <CodeHighlighter file_name="index.html" code={codeExemple1.code} head={codeExemple1.head} language="html" is_html={true} title="onmousedown" addClass="mt-3 mb-3" copie={true}  number={false}/>  
