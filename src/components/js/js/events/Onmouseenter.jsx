...
function small(x) {
  ...
  <section className="section-conetent">
    ...
    <article>
        ...
        <CodeHighlighter file_name="index.html" code={codeExemple1.code} head={codeExemple1.head} language="html" is_html={true} title="onmouseenter" addClass="mt-3 mb-3" copie={true}  number={false}/>  
        ...
        <Result title="onmouseenter"  logo={images.html_logo}  route="file:///C:/Users/SURFACE%20BOOK/Desktop/html/index.html" >
            <img ref={imageRef} src={images.hajime} onMouseEnter={bigFunction} onMouseLeave={smallFunction} style={{ width:"64px",height:"64px"}} alt="logo"/>
            <p>The function big() is triggered when the mouse pointer is moved onto the image.</p>
            <p>The function small() is triggered when the mouse pointer is moved out of the image.</p>
        </Result>
    </article>
