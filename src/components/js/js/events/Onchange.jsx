...
selectElement.addEventListener("change", ()=>{
  ...
  <section className="section-conetent">
    ...
    <article>
        ...
        <CodeHighlighter file_name="index.html" code={codeExemple1.code} language="html" is_html={true} title="onchange " addClass="mt-3 mb-3" copie={true}  number={true}/>  
        ...
        <CodeHighlighter file_name="index.html" code={codeExemple2.code} language="html" is_html={true} title="onchange " addClass="mt-3 mb-3" copie={true}  number={true}/>  
