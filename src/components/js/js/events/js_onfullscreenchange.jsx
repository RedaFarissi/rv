...
<h1 class="heading-style-js"><u><i>  JavaScript onfullscreenchange </i></u></h1>
...
<div class="codeStudio alert bg-dark mt-2 pb-0" dir="ltr" >
<b class="d-block mt-3 text-danger"> Open fullscreen </b>
...
<b class="d-block text-danger">Close fullscreen </b>
...
<div class="sum_exemple_style">
    ...
    <img src="{% static 'js/js122_onfullscreenchange.png' %}" class="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div class="styleee">  
        <div class="h2">Fullscreen with JavaScript</div>
