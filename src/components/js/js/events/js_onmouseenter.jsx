{% load static %} 
<h1 class="heading-style-js"><u><i>  JavaScript onmouseenter </i></u></h1>
...
<div class="sum_exemple_style">
    ...
    <img src="{% static 'js/js111_onmouseenter.png' %}" class="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div class="styleee img">
        <img id="img" onmouseenter="big(this)" onmouseleave="small(this)" src="./js/hajime.jpg" style="width:30px;height:30px;border-radius:50%;">
