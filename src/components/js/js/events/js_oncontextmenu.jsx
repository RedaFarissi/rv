...
<h1 class="heading-style-js"><u><i>  JavaScript oncontextmenu </i></u></h1>
<div class="style_divv mt-5">
    يقع حدث <b>oncontextmenu</b> عندما ينقر المستخدم بزر الماوس الأيمن فوق عنصر لفتح قائمة السياق.<br>
    <div class="alert alert-warning mt-2"> على الرغم من أن حدث <b>oncontextmenu</b> مدعوم في جميع المتصفحات ، إلا أن سمة <b>contextmenu</b> مدعومة حاليًا في <b>Firefox</b> فقط.</div>
...
<div class="sum_exemple_style">
    ...
    <img src="{% static 'js/js100_oncontextmenu.png' %}" class="img">
