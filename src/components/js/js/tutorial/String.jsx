...
<section className="section-conetent">
    ...
    <article>
        ...
        <img src="{% static 'js/js8_string.png' %}" class="img"/>
        <img src="{% static 'js/js8_string 2.png' %}" class="img"/>
        <div class="mital"> متال 2 :  </div>
        <ul><li> في هاذا المتال قمنا بعرض النتيجة مباشرة . </li></ul>
        <img src="{% static 'js/js8_string2.png' %}" class="img"/>
        <img src="{% static 'js/js8_string2 2.png' %}" class="img"/>
        ...
        <div class="mital"> متال :  </div>
        <img src="{% static 'js/js8_string4.png' %}" class="img"/>
        <img src="{% static 'js/js8_string4 2.png' %}" class="img"/>
        <div class="mital"> متال 2 :  </div>
        <img src="{% static 'js/js8_string5.png' %}" class="img"/>
        <img src="{% static 'js/js8_string5 2.png' %}" class="img"/>
        ...
        {/* <div class="codeStudio alert bg-dark OBject" dir="ltr" style="margin-top: 9px;padding-bottom:0pt;">
        ...
        <div class="mital"> متال  :  </div>
        <img src="{% static 'js/js8_string6.png' %}" class="img"/>
        <img src="{% static 'js/js8_string6 2.png' %}" class="img"/>
        <div class="mital"> متال 2 :  </div>
        <img src="{% static 'js/js8_string7.png' %}" class="img"/>
        <div class="styleee"><h2>Reda</h2></div>
        ...
        <div class="mital"> متال :  </div>
        <img src="{% static 'js/js8_string8.png' %}" class="img"/>
        <div class="styleee"><h2> Banana </h2></div>
        <div class="mital"> متال 2 :  </div>
        <img src="{% static 'js/js8_string12.png' %}" class="img"/>
        <div class="styleee"><h2> Banana </h2></div>
        ...
        <div class="mital"> متال :  </div>
        <img src="{% static 'js/js8_string9.png' %}" class="img"/>
        <div class="styleee"><h2> Kiwi </h2></div>
        ...
        <div class="mital"> متال :  </div>
        <img src="{% static 'js/js8_string10.png' %}" class="img"/>
        <div class="styleee"><h2> Ba </h2></div>
        <div class="mital"> متال 2 :  </div>
        <ul><li> تستقبل الدالة القيم السالبة أيضا </li></ul>
        <img src="{% static 'js/js8_string11.png' %}" class="img"/>
        <div class="styleee"><h2> Kiwi </h2></div>
        ...
        <img src="{% static 'js/js8_string13.png' %}" class="img"/>
        <div class="styleee"><h2> Please visit JavaScript </h2></div>
        <div class="alert bg-warning" >
        <ul>
        ...
        <div class="mital"> متال :  </div>
        <img src="{% static 'js/js8_string14.png' %}" class="img"/>
        <div class="styleee"><h2> HELLO WORD </h2></div>
        <div class="mital"> متال 2 :  </div>
        <img src="{% static 'js/js8_string15.png' %}" class="img"/>
        <div class="styleee"><h2> hello word </h2></div>
        ...
        <div class="mital"> متال :  </div>
        <img src="{% static 'js/js8_string16.png' %}" class="img"/>
        <div class="styleee"><h2> Reda Eskouni </h2></div>
        <div class="mital"> متال 2 :  </div>
        <img src="{% static 'js/js8_string17.png' %}" class="img"/>
        <div class="styleee"><h2> Reda Eskouni </h2></div>
        ...
        <div class="mital"> متال :  </div>
        <img src="{% static 'js/js8_string18.png' %}" class="img"/>
        <div class="styleee"><h2> Reda </h2></div>
        ...
        <div class="mital"> متال :  </div>
        <img src="{% static 'js/js8_string19.png' %}" class="img"/>
        <div class="styleee"><h2>0005</h2></div>
        <div class="mital"> متال 2 :  </div>
        <img src="{% static 'js/js8_string20.png' %}" class="img"/>
        <div class="styleee"><h2>0000Reda</h2></div>
        <h5 className="title-h5">2. <bdi>padEnd()</bdi></h5>
        <div class="mital"> متال :  </div>
        <img src="{% static 'js/js8_string21.png' %}" class="img"/>
        <div class="styleee"><h2>5000</h2></div>
        ...
        <div class="mital"> متال :  </div>
        <img src="{% static 'js/js8_string22.png' %}" class="img"/>
        <div class="styleee"><h2>H</h2></div>
        ...
        <div class="mital"> متال :  </div>
        <img src="{% static 'js/js8_string23.png' %}" class="img"/>
        <div class="styleee"><h2> HTML <br/> CSS<br/> JavaScript<br/> PHP<br/> MYSQL<br/> React<br/> undefined </h2></div>
    </article>
</section>
    )
}