...
<section className="section-conetent">
    <h1 className="heading-style">JavaScript setAttribute</h1>
    <article>
        ...
        <CodeHighlighter file_name="index.html" code={codeExemple1.code} head={codeExemple1.head} language="html" is_html={true} title="appendChild" addClass="mt-3 mb-3" copie={true}  number={false}/>  
