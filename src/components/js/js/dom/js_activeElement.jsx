{% load static %} 
<h1 class="heading-style-js"><u><i> JavaScript activeElement </i></u></h1>
...
<div class="sum_exemple_style">
    ...
    <img src="{% static 'js/js57_activeElement.png' %}" class="img">
...
<div class="sum_exemple_style">
    ...
    <h4 style="color:green"> الكود </h4>
    <img src="{% static 'js/js57_activeElement2.png' %}" class="img">
    <h4 style="color:green"> بعد تشغيل الأكواد </h4>
    <div class="styleee img">
        <main onclick="tag_name()">
            <h2 style="background-color: yellow;">The activeElement Property</h2>
