...
function function openFullscreen() {
    ...
    <CodeHighlighter file_name="index.html" code={codeExemple1.code} language="html" is_html={true} title="requestFullscreen" addClass="mt-3 mb-3" copie={true}  number={false}/>  
