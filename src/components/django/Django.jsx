...
<main>
   ...
   <section className="section-conetent ">
      ...
      <article>
            ...
            <ul><li>الآن كل المسار الذي تم إنشاؤها في helloapp/urls.py موجود في : <bdi><b>localhost:8000/helloapp/</b></bdi></li></ul>
            ...
            <h3 className="title-h3" id="templates"> 4 - templates</h3>
            <p className="style_divv">
            ...
            <h3 className="title-h3" id="urls"> 5 - urls </h3>
            <p className="style_divv">
            ...
            <h3 className="title-h3" id="views"> 6 - views </h3>
            <p className="style_divv">
            ...
            <h3 className="title-h3" id="models"> 7 - models</h3>
            <p className="style_divv">
               في Django، ال models هو تمثيل لجدول في قاعدة البيانات. يستخدم ال models  لتحديد هيكل البيانات والعلاقات بينها، ويوفر وسيلة للتفاعل مع قاعدة البيانات بطريقة برمجية.
            </p>
            <CodeHighlighter code={""} file_name="project / helloapp / models.py" language="python" number={true} addclassName="mt-3 mb-3" copie={true}/> 
            <ul><li>هذا الكيان سوف تنعكس على قاعدة البيانات  <bdi>( يجب إستخدامه في كل مرة قمة بإجراء تعديلات )</bdi></li></ul>
            <CodeCommand>python manage.py makemigrations</CodeCommand>
            <CodeCommand>python manage.py migrate</CodeCommand>
            <p className="mt-3"> When you use command top in helloapp/migrations/ will create file Content : </p>
            <p><b>if you got some prombale when change class in models use </b></p>
            <CodeCommand>python manage.py makemigrations helloapp zero</CodeCommand>
            <CodeCommand>python manage.py migrate</CodeCommand>
            <img src={images.django5} className="img"/>
         
            <br id="Administering_data_in_Django"/><br/>
            <h2>8 - Administering data in Django </h2>
            <CodeCommand>python manage.py createsuperuser</CodeCommand>
            <b>go to link : <a href="#">http://127.0.0.1:8000/admin/</a> </b>
            ...
            <br id="create_file_to_avoid_repeat"/><br/>
            <h2>10 - create layoute or any name file to avoid repeat (mise a jour) </h2>
            <div className="  fs-5 p-4 pb-2 rounded">
