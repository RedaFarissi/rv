...
export default function Form(){
    ...
    <article id="Form">
        ...
        <p className="style_divv">
            <b>form.cleaned_data</b> :  هو قاموس يحتوي على البيانات التي تم تنظيفها والتحقق من صحتها من النموذج المقدم.<br/>
            يتوفر قاموس البيانات النظيفة بعد التحقق من صحة النموذج بنجاح.<br/>
