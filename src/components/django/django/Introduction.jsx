...
export default function Introduction(props){
   ...
   <>
         ...
         <article id="What_is_Django" className="mt-5">
           <h2 className="title-h2 mt-5">1 - ما هو Djnago . </h2>
         ...
         <article id="What_you_need_to_get_started">
           <h2 className="title-h2"> 2 - django  ما تحتاجه لاستخدام. </h2>
           <p className="style_divv">
              <ul>
         ...
         <article id="Verify_required_installations">
           <h2 className="title-h2"> 3 - التحقق من التثبيتات المطلوبة</h2>
