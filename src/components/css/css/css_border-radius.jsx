{% load static %} 
<h1 class="heading-style-css"><u><i>  CSS border-radius </i></u></h1>
...
<div id="border_radius_exemple" class="alert p-4 rounded m-auto border border-primary border-2 text-dark" dir="ltr">
  <div id="input_radio_box" class="border border-secondary rounded bg-light p-3">
    ...
    <div>
      <input type="radio" name="bo-sh6" onclick="border_radius(this.value)" value="30px" id="border_r"/>  30px<br>
      <input type="radio" name="bo-sh6" onclick="border_radius(this.value)" value="25% 10%"/>  25% 10% <br>
      <input type="radio" name="bo-sh6" onclick="border_radius(this.value)" value="10% 30% 50% 70%"/>  10% 30% 50% 70% <br>
      <input type="radio" name="bo-sh6" onclick="border_radius(this.value)" value="10% / 50%"/>  10% / 50%<br>
      <input type="radio" name="bo-sh6" onclick="border_radius(this.value)" value="10px 100px"/>  10px 100px <br>
      <input type="radio" name="bo-sh6" onclick="border_radius(this.value)" value="50% 20% / 10% 40%"/> 50% 20% / 10% 40% <br>
      <input type="radio" name="bo-sh6" onclick="border_radius(this.value)" value="50% 20% 10% 40%"/> 50% 20%  10% 40% <br>
      <input type="radio" name="bo-sh6" onclick="border_radius(this.value)" value="50%"/> 50% 
    </div>
    <div id="Code" class="mt-4 w-100">
       <div class="h3"> Code: </div>
       <div class="border py-2 ps-2 w-100" >
           <span style="font-weight:500;">border-radius :</span> <span id="border-radius-result" style="font-weight:500"></span>
       </div>
    </div>
  </div>
...
<script>
  ...
  document.getElementById("border_r").click()
</script>