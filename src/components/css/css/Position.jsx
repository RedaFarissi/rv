...
<section className="section-conetent">
    ...
    <article>
        ...
        <img src={images.css28_position} class="img"/>
        <img src={images.css28_position_2} class="img"/>
        ...
        <img src={images.css28_position2} class="img"/>
        <img src={images.css28_position2_2} class="img"/>
        <div class="mital"> متال 2 : </div>
        <img src={images.css28_position3} class="img"/>
        <img src={images.css28_position3_2} class="img"/>
    </article>
</section>
)
}