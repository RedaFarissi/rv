...
<img src={images.css45_filter} class="img"/>
<img src={images.css45_filter_2} class="img"/>
</div>
<br/>
...
<div class="sum_exemple_style">
<div class="mital">متال : </div>
<img src={images.css45_filter2} class="img"/>
<img src={images.css45_filter2_2} class="img"/>
</div>
<br/>
...
<div class="sum_exemple_style">
<div class="mital">متال : </div>
<img src={images.css45_filter3} class="img"/>
<img src={images.css45_filter3_2} class="img"/>
</div>
<br/>
...
<div class="sum_exemple_style">
<div class="mital">متال : </div>
<img src={images.css45_filter4} class="img"/>
<img src={images.css45_filter4_2} class="img"/>
</div>
<br/>
...
<div class="sum_exemple_style">
<div class="mital">متال : </div>
<img src={images.css45_filter5} class="img"/>
<img src={images.css45_filter5_2} class="img"/>
</div>
<br/>
...
<div class="sum_exemple_style">
<div class="mital">متال : </div>
<img src={images.css45_filter6} class="img"/>
<img src={images.css45_filter6_2} class="img"/>
</div>
<br/>
...
<div class="sum_exemple_style">
<div class="mital">متال : </div>
<img src={images.css45_filter8} class="img"/>
<img src={images.css45_filter8_2} class="img"/>
</div>
...
<div id="blur_exemple" class="alert p-4 rounded m-auto border border-primary border-2 text-dark" dir="ltr">
	...
	<div class="border bg-light border-secondary" id="Blur_E">
    	...
    	<div> <img src={images.orange.jpg"  id="img_test"> </div>
	</div>
</div> */}
</section>
)
