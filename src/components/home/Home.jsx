    ...
    <main className="main-home">
      ...
      />
        ...
        <HomeBox 
          ...
          paragraph="باختصار، powerShell هو لغة برمجة وواجهة أوامر متقدمة في نظام التشغيل ويندوز. تم تصميمه لتمكين الأتمتة وإدارة النظام بشكل أفضل من خلال استخدام أوامر موحدة وسهلة الفهم وقوية في السياق البرمجي. يستخدم باورشيل cmdlets (أوامر صغيرة تقوم بوظائف محددة) ويوفر إمكانيات البرمجة الشاملة والتكامل مع البنية الأساسية لـ .NET Framework."
      />
