              ...
              <div className="box-lang">
                <Link to="/mysql" className="text-light text-decoration-none ">
                  ...
                  <div class="card-body">
                      ...
                      <p class="card-text"> MySQL هو نظام إدارة قواعد البيانات العلاقية مفتوح المصدر يستخدم لغة الاستعلام المهيكلة (SQL) لإدارة واستعلام البيانات. يُستخدم على نطاق واسع في تطبيقات الويب ويدعم مجموعة متنوعة من أنظمة التشغيل. يوفر MySQL التوسعة والموثوقية والأداء، مما يجعله خيارًا شائعًا للشركات بمختلف الأحجام. يسهل تخزين البيانات واسترجاعها وتلاعبها بكفاءة من خلال مجموعته الشاملة من الميزات والوظائف. </p>
                  </div>
                </Link>
              </div>
