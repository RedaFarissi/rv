...
export default function Variables(){
    return(
    <>
        <h1 className="heading-style heading-style-python-color"> Python Variables</h1>   
        <article className="mt-5">
            <h2 className="title-h2"> 1 - تسمية المتغير . </h2>
            ...
            <h2 className="title-h2"> 2 - تخصيص المتغير . </h2>
            <p className="style_divv">
                <ul>
            ...
            <h2 className="title-h2"> 3 - أنواع البيانات . </h2>
            <p className="style_divv">
                <ul>
...
my_list = [1, 2, 3]  # List`} language="python" addclassName="mt-3 mb-3" copie={true}/>   
            <h2 className="title-h2"> 4 - إعادة تخصيص المتغير . </h2>
...
x = "Hello"`} language="python" addclassName="mt-3 mb-3" copie={true}/>   
            <h2 className="title-h2"> 5 - طباعة المتغيرات . </h2>
...
print(my_variable)`} language="python" addclassName="mt-3 mb-3" copie={true}/>   
            <h2 className="title-h2"> 6 - الطباعة الدينامية . </h2>
...
x = "Hello"  # String`} language="python" addclassName="mt-3 mb-3" copie={true}/>
            <h2 className="title-h2"> 7 - الثوابت . </h2>
