    ...
    render() {
      return (
        <div
          ...
          >
          <div className="event-js-content">{this.props.box.name}</div>
        </div>
      );
    }
}
...
class EventExemple2 extends React.Component {
  ...
  render() {
    return <div className="event-js-boxesGroup">{this.makeBoxes()}</div>;
  }
}
