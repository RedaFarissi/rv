...
export default function Component(){
    return(
<div>
    <h1 className="heading-style" id="Component"> React Components </h1>
    ...
    <article id="JSX">
        <h2 className="title-h2">1 - ما هو (JSX)</h2>
        <p className="style_divv">
    ...
    <article id="function_Component">
            <h2 className="title-h2">2 - مكوّن الدالة (Function Component):</h2>
            <ul>
    ...
    <article id="function_Component_props">
            <h2 className="title-h2">3 - مكوّن الدالة الذي يقبل خصائص (props).</h2>
            <ul>
    ...
    <article id="class_Component">
            <h2 className="title-h2">4 - مكوّن الفئة (Class Component)</h2>
            <CodeHighlighter code={codes[1].class_Component[0]} language="jsx" number={false} addclassName="mt-3 mb-3" copie={true}/>
            <article>
            </article>
    </article>
    <article id="class_Component_this_props">
            <h2 className="title-h2">5 - مكوّن الفئة (Class Component this.props)</h2>
    ...
    <article id="Components_in_Component">
        <h2 className="title-h2">6 - المكونات في المكون </h2>
