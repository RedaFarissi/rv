...
export default function  Meta(props){
    ...
    const codeExemple1 = `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title> Meta  </title>
...
<head>
    <meta charset="UTF-8">
    <meta name="keywords" content="HTML, CSS, JavaScript, React.js, Vue.js, PHP, Laravel, Python, Django">
</head>
<body>
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Explore a comprehensive course covering HTML, CSS, JavaScript, React.js, Vue.js, PHP, Laravel, Python, and Django. Learn the fundamentals of web development and delve into advanced topics, including popular front-end frameworks, dynamic scripting languages, and powerful server-side frameworks. Gain practical skills and insights to build modern, responsive, and feature-rich web applications.">
</head>
<body>
...
<head>
    <meta charset="UTF-8"/>
    <meta name="author" content="Reda Eskouni"/>
</head>
<body>

</body>
</html>`
const codeExemple5  =`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1"/> 
...
<article>
    ...
    <CodeHighlighter code={codeExemple1} language="html" title="Meta" addClass="mt-3 mb-3" copie={true}/>
</article>
<article>
    ...
    <CodeHighlighter code={codeExemple2} language="html" title="Meta" addClass="mt-3 mb-3" copie={true}/>
    ...
    <CodeHighlighter code={codeExemple3} language="html" title="Meta" addClass="mt-3 mb-3" copie={true}/>
    <h5>3.  مؤلف صفحة </h5>
    <p className="style_divv">
    ...
    <CodeHighlighter code={codeExemple4} language="html" title="Meta" addClass="mt-3 mb-3" copie={true}/>
    ...
    <CodeHighlighter code={codeExemple5} language="html" title="Meta" addClass="mt-3 mb-3" copie={true}/>
