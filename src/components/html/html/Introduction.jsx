...
export default function Introduction(props){
    ...
    const code2 = `     <article>
        ...
        Eagles belong to several groups of genera, some of which are closely related. True eagles comprise the genus 
        Aquila. Most of the 68 species of eagles are from Eurasia and Africa.[1] Outside this area, just 14 species 
                can be found—two in North America, nine in Central and South America, and three in Australia.<br/>
...
<>
    ...
    <article>
        ...
        <p className="style_divv">
        التعليق <b>(Comment)</b> عبارة عن وسم خاص يمكنك وضعه في أي مكان تريد في الصفحة بهدف كتابة ملاحظات تساعدك في الشرح أو لتذكر سبب استخدام الوسوم في حال أردت مستقبلاً مراجعة كود الصفحة و التعديل عليه.
    ...
    <article>
        ...
        <CodeHighlighter 
            ...
            copie={true}
            number={false}
            modeColorCode={props.modeColorCode}
        /> 
    </article>
    <article>
    ...
    <article>
        ...
        <div className="style_divv">
            ...
            تصف عناصر الرأس بشكل جماعي خصائص المستند مثل العنوان title ، وتوفر معلومات وصفية مثل مجموعة الأحرف <b>character set</b> ، وتوجه المتصفح إلى مكان العثور على أوراق الأنماط أو البرامج النصية التي تسمح لنا بتوسيع نطاق صفحة <b>HTML</b> بطرق نشطة وتفاعلية للغاية.
    ...
    <article>
        ...
        <div className="sum_exemple_style">
            <CodeHighlighter file_name="index.html" is_html={true} code={code2} language="html" title='Eagle' number={false} addclassName="mt-3 mb-3" copie={true}/>
